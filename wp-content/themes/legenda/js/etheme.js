    ...
    */
    ...
    function et_bind_variations_form() {
        ...
        $( 'form.variations_form' ).on( 'found_variation', function( event, variation ) {
            ...
            if ( $( '.main-image-slider' ).hasClass( 'zoom-enabled' ) ) {
                if( $(window).width() > 768 && et_variation['image'].length > 5 && et_variation['link'].length > 5 ){
                    $( 'a#main-zoom-image' ).swinxyzoom( 'load', et_variation['link'],  et_variation['link'] );
                }
                $( 'a#main-zoom-image' ).attr('href', et_variation['link']);
                $( '.product-thumbnails-slider li:eq(0) img' ).attr( 'src', et_variation['image'] );
            } else {
                $( 'a#main-zoom-image' ).attr( 'href', et_variation['link'] );
                $( '.product-thumbnails-slider li:eq(0) img' ).attr('src', et_variation['image'] );
            }
        ...
        .on( 'reset_image', function( event ) {
            ...
            var $product_link   = $product.find( 'a#main-zoom-image' );
            var o_data = {
                src: $product_img.attr( 'data-o_src' ),
            ...
            if ( $( '.main-image-slider' ).hasClass( 'zoom-enabled' ) ) {
                ...
                $( '.product-thumbnails-slider li:eq(0) img' ).attr( 'src', o_data['src'] );
            } else {
        ...
        $( document ).on( 'click', '.product_meta table.variations select ,.reset_variations', function() {
