					...
					<?php while(have_posts()) : the_post(); ?>
						...
						<?php 
							...
							if( ! empty( $posts['products'] ) ) {
								...
								<h3 class="title"><span><?php esc_html_e('Products results', ETHEME_DOMAIN); ?></span></h3>
								<a href="<?php echo get_bloginfo('url').'/?s='.$args['s']; ?>&post_type=product" title="<?php esc_html_e('Show all', ETHEME_DOMAIN); ?>" class="view-all-results"><?php _e('Show all', ETHEME_DOMAIN); ?></a>
									<div>
										<?php
								...
								?>
									<p class="warning"><?php esc_html_e('No products found maching your request.', ETHEME_DOMAIN) ?></p>
								<?php
							}
							endif;
							...
							if( ! empty( $posts['posts'] ) ) {
								...
								<div class="blog-results">
									<h3 class="title"><span><?php esc_html_e('Blog results', ETHEME_DOMAIN); ?></span></h3>
									<a href="<?php echo get_bloginfo('url').'/?s='.$args['s']; ?>&post_type=post" title="<?php esc_html_e('Show all', ETHEME_DOMAIN); ?>" class="view-all-results"><?php esc_html_e('Show all', ETHEME_DOMAIN); ?></a>
									<div>
										<?php
							...
							if( ! empty( $posts['portfolio'] ) && $args['portfolio'] ) {
								?>
								<h3 class="title"><span><?php esc_html_e('Portfolio results', ETHEME_DOMAIN); ?></span></h3>
							...
							if( ! empty( $posts['pages'] ) && $args['pages'] ) {
								?>
								<h3 class="title"><span><?php esc_html_e('Pages', ETHEME_DOMAIN); ?></span></h3>
