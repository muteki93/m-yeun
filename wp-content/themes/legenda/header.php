					...
					<div class="menu-wrapper">
						...
						<div class="modal-buttons">
							...
							<?php if (is_user_logged_in() && etheme_get_option('top_links')): ?>
								<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="my-account-link hidden-desktop">나의 계정</a>
							<?php elseif(etheme_get_option('top_links')): ?>
								<a class="popup-with-form my-account-link hidden-tablet hidden-desktop" href="#loginModal">로그인/회원가입</a>
							<?php endif ?>
							<?php if (etheme_get_option('search_form')): ?>
