            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                echo '<div id="option-tree-sub-header">';
                      ...
                      if ( ! empty( $activated_data['purchase'] ) && $activated_data['theme'] == 'legenda' ) {
                        $activated_data['data'] = '<strong> Theme Activated</strong> - ' . $activated_data['purchase'];
                      } else {
                        $activated_data['data'] = '<strong> Please activate Theme</strong>';
                      }

                      echo '<h3 class="theme-tittle">'.$this->options[0]['pages'][0]['theme_name'].'</h3>'.'<span class="theme-version">v ' . $theme_data->version . $activated_data['data'] .'</span>';
                    /* layouts form */
