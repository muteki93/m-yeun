...
if (!function_exists('custom_theme_options')) {
    function custom_theme_options($return = false) {
       ...
       */
       ...
       $settings = array(
            ...
            array(
                'id'          => 'logo-fixed',
                'label'       => __('Logo image for fixed header', ETHEME_DOMAIN),
                'default'     => '',
                'desc'        => 'Upload image: png, jpg or gif file',
                'type'        => 'upload',
                'section'     => 'header'
    ...
    <h2>No products were found</h2>
            ...
            array(
                'id'          => 'tabs_position',
                'label'       => __('Tabs position', ETHEME_DOMAIN),
                'default'     => 'tabs_default',
                'type'        => 'select',
                'section'     => 'single_product',
                'class'       => '',
                'choices'     => array(
                    array(
                        'value'   => 'tabs-under',
                        'label'   => __('Under Content', ETHEME_DOMAIN)
                    ),
                    array(
                        'value'   => 'tabs-inside',
                        'label'   => __('Inside Content', ETHEME_DOMAIN)
                    )
                )
            ),
            array(
    ...
    <h5>Ship your item back to Us</h5>Firstly Print and return this Returns Form to:<br /> <p>30 South Park Avenue, San Francisco, CA 94108, USA<br /> Please remember to ensure that the item you are returning is repackaged with all elements.</p><br /> <span class="underline">For more information, view our full Returns and Exchanges information.</span>[/column][/row]
            ...
            array(
                ...
                'label'       => __('Show out of stock products in Ajax search form', ETHEME_DOMAIN),
                'type'        => 'checkbox',
                'section'     => 'search',
                'default'     => array(0=>1),
                'choices'     => array(
            ...
            array(
                ...
                'label'       => __('Search result count', ETHEME_DOMAIN),
                'desc'        => __('<b>Example: </b> 5', ETHEME_DOMAIN),
                'type'        => 'text',
                'section'     => 'search',
                'default'     => 3
            ),
            array(
                ...
                'choices'     => array(
                    array(
                        'value'   => 1,
                        'label'   => __('Enabled', ETHEME_DOMAIN)
                    ),
                    array(
                        'value'   => 0,
                        'label'   => __('Disabled', ETHEME_DOMAIN)
                    ),
                    array(
                        'value'   => 'home',
                        'label'   => __('Enabled for home only', ETHEME_DOMAIN)
                    )
                )
            ),
            array(
