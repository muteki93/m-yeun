...
class ETheme_Version_Check {
    ...
    public function activation_page() {
        ...
        ?>
            ...
            <?php else: ?>
                <p><?php _e('Use your purchase code to activate Legenda template. Please, note, that you won’t be able to use it without activation.', 'etheme'); ?></p>
                <p><?php _e('To find your Purchase code, please, enter your ThemeForest account > Downloads tab > choose etheme > Download > License Certificate & Purchase code', 'etheme'); ?> <a href="http://prntscr.com/d23p2c" target="_blank">http://prntscr.com/d23p2c</a></p>
                <p><?php _e('Activate Legenda template and get lifetime updates, 6 months of free top-notch support, 24/7 live support and much more.', 'etheme'); ?></p>
                
                <p><?php _e('A purchase code (license) is only valid for One Project. Do you want to use this theme for a one more project? Purchase a <a href="https://themeforest.net/item/legenda-responsive-multipurpose-wordpress-theme/5888906?license=regular&open_purchase_for_item_id=5888906&purchasable=source&ref=8theme">new license here</a> to get a new purchase code.', 'etheme'); ?></p>

                <form action="" class="etheme-form" method="post">
                    <p>
                        <label for="purchase-code"><?php _e('Purchase code', 'etheme'); ?></label>
    ...
    public function setup_notice() {
        $this->notices['_setup'] = array(
            'message' => '
                <p><strong>Welcome to Legenda</strong> – You‘re almost ready to start selling :)</p>
                <p class="submit"><a href="' . admin_url( 'themes.php?page=etheme-setup' ) . '" class="button-primary">Run the Setup Wizard</a> <a class="button-secondary skip" href="' . esc_url( wp_nonce_url( add_query_arg( 'et-hide-notice', 'setup' ), 'etheme_hide_notices_nonce', '_et_notice_nonce' ) ). '">Skip Setup</a></p>
            '
        );
    }
    ...
    public function activation_notice() {
        $this->notices['_activation'] = array(
            'message' => '
                <p><strong>You need to activate Legenda</strong></p>
                <p class="submit"><a href="' . admin_url( 'themes.php?page=etheme-setup' ) . '" class="button-primary">Activate theme</a></p>
            '
        );
    }
