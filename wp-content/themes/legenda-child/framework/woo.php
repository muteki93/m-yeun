				...
				<div>
					...
					<div class="modal-body">
						...
						<form method="post" class="login">
                            ...
                            <?php else: ?>
                                <a href="#loginModal" class="right"><?php _e('Create Account', ETHEME_DOMAIN) ?></a>
                            <?php endif ?>
							</p>
						</form>
					</div>
...
if(!function_exists('et_cart_summ')) {
	function et_cart_summ() {
        global $woocommerce;
        ?>
			<a href="<?php echo WC()->cart->get_cart_url("/"); ?>" class="cart-summ" data-items-count="<?php echo WC()->cart->get_cart_contents_count(); ?>">
				<div class="cart-bag">
